    ...
    public partial class UOMEdit : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!sqlDataReader.Read())
            {
                ...
                {
                    cmd = new SqlCommand("Update UOM set InternalUOM=N'" + txtUint.Text + "',TaxUOM='" + cmbUnit.Text + "',Description='" + txtDescEn.Text + "',ArabicDescription=N'" + txtDescAr.Text + "' Where ID=" + uomID + " ", cn);
                    try
                    {
                        cn.Open();
                        cmd.ExecuteNonQuery();
            ...
            {
                cn.Close();
                MessageBox.Show("وحدة القياس موجوده بالفعل ");
            }
        }
        #region Helper
        public void Clear()
